from minihand.commands import command, Command
from minihand.core import MiniHand
from importlib import reload as Reload


@command(name="help", aliases=["도움", "도움말"], shorthelp="도움 커맨드입니다.")
...
@command(name="reload", aliases=["ㄹ", "리로드"], shorthelp="모든 커맨드 리로드.")
def reload(ctx):
